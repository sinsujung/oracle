...
/*
    ...
    [ORDER BY order_exprestion [ASC|DESC]]
...
SELECT * FROM TBLINSA WHERE BASICPAY BETWEEN 1020000 AND 1100000; --최솟값 포함, 최댓값 포함
...
SELECT * FROM TBLINSA WHERE IBSADATE >= '2000-01-01' AND IBSADATE <= '2000-12-31'; -- 2000년 이후에 입사한 직원
...
SELECT  * FROM TBLCOUNTRY WHERE POPULATION is NOT null ; -- ***사람들이 이걸 좀 더 많이 씀
...
-- 연락처가 없는 직원
SELECT * FROM TBLTODO  WHERE  tel IS NULL ;


-- 아직 실행하지 않은 할 일?
SELECT * FROM TBLTODO  WHERE  completedate IS NOT NULL ;

-- 도서관 > 대여 테이블(컬럼: 대여날짜, 반납 잘짜,)
