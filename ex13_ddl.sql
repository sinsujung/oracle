...
-- ORA-00001: unique constraint (HR.SYS_C007092) violated
INSERT INTO tblMemo(seq, name, memo, regdate)
				VALUES (1, '홍길동', '메모입니다.', sysdate);
...
-- ORA-00001: unique constraint (HR.SYS_C007099) violated
INSERT INTO tblMemo(seq, name, memo, regdate)
				VALUES (2, '홍길동', '메모입니다.', sysdate);
...
--ORA-02290: check constraint (HR.SYS_C007100) violated
INSERT INTO tblMemo(seq, name, memo, regdate, priority, category)
