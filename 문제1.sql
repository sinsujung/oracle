...
SELECT
	*
FROM TBLINSA
	WHERE ssn LIKE '___7__-_______'OR ssn LIKE '___8__-_______'OR ssn LIKE '___9__-_______';
...
SELECT
	*
FROM TBLINSA
	WHERE BUSEO IN ('기획부', '총무부', '개발부') AND JIKWI IN ('사원', '대리') AND TEL LIKE '010-____-____';
...
SELECT
	*
FROM TBLINSA
	WHERE CITY IN ('서울', '인천', '경기') AND IBSADATE LIKE '2008-__-__' OR IBSADATE LIKE '2009-__-__' OR IBSADATE LIKE '2010-__-__';
